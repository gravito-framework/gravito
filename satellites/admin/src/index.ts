...
import { DashboardController } from './Interface/DashboardController'
...
export class AdminServiceProvider extends ServiceProvider {
  register(container: Container): void {
    ...
    container.bind('admin.usecase.dashboardStats', () => new GetDashboardStats())
    ...
    container.singleton('admin.controller.dashboard', () => new DashboardController(this.core!))
  }
  ...
  override boot(): void {
    ...
    const dashboardController = core.container.make<DashboardController>(
    ...
    core.router.group({ prefix: '/api/admin/v1' }, (router) => {
      ...
      router.get('/dashboard/stats', (ctx) => dashboardController.stats(ctx))
