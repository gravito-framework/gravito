...
import { User, LogOut, Settings, Shield, Activity, Clock, Server, ChevronRight } from 'lucide-react'
                ...
                {isOpen && (
                    ...
                    >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-1 mt-1">
                                        ...
                                        <span className="text-[9px] font-bold text-green-500 uppercase tracking-widest">Full Access</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-muted/20 border-b">
                            <p className="text-[9px] font-black text-muted-foreground/50 uppercase tracking-widest mb-3">System Status</p>
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-bold">{systemStatus?.memory?.rss || '...'}</span>
                                </div>
                            </div>
                        </div>
