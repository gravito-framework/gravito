...
import { Lock, Activity, AlertCircle, Eye, EyeOff, ArrowRight } from 'lucide-react'
        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-[10px] font-bold text-primary uppercase tracking-[0.4em]">Flux Console</p>
                </div>
                ...
                <div className="card-premium p-8 backdrop-blur-xl">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">Enter your password to access the console</p>
                    </div>
