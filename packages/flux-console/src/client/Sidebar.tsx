      ...
      <div className="p-6 flex items-center gap-4">
        ...
        {!collapsed && (
          <div className="font-black text-xl tracking-tighter leading-none animate-in fade-in slide-in-from-left-2">
            GRAVITO{' '}
            <span className="text-primary block text-[10px] tracking-[0.3em] uppercase opacity-70 mt-1">
              Flux Engine
            </span>
          </div>
        )}
        ...
        {navItems.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              />
              {!collapsed && (
                <span className="font-semibold whitespace-nowrap tracking-tight">{item.label}</span>
              )}
              {isActive && (
                <motion.div
