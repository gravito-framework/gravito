 ...
 */
export type RelationType = 'hasMany' | 'belongsTo' | 'hasOne' | 'belongsToMany' | 'morphTo' | 'morphMany' | 'morphOne';
/**
 * Relation definition.
 */
...
export interface ModelStatic<T extends Model = Model> {
    ...
    castAttribute(key: string, value: unknown, cast: CastType | ((value: unknown) => unknown)): unknown;
    ...
    findAll(where?: WhereCondition, options?: {
        limit?: number;
        orderBy?: unknown;
        orderDirection?: 'asc' | 'desc';
    }): Promise<ModelCollection<T>>;
...
export declare abstract class Model<TAttributes = Record<string, unknown>> {
     ...
     */
    static where<T extends Model>(this: ModelStatic<T>, column: string, value: unknown): Promise<T | null>;
    /**
     ...
     */
    static all<T extends Model>(this: ModelStatic<T>, options?: {
        limit?: number;
        orderBy?: unknown;
        orderDirection?: 'asc' | 'desc';
    }): Promise<ModelCollection<T>>;
     ...
     */
    static findAll<T extends Model>(this: ModelStatic<T>, where?: WhereCondition, options?: {
        limit?: number;
        orderBy?: unknown;
        orderDirection?: 'asc' | 'desc';
    }): Promise<ModelCollection<T>>;
     ...
     * Paginate.
     */
    static paginate<T extends Model>(this: ModelStatic<T>, options: {
        page: number;
        limit: number;
        orderBy?: unknown;
        orderDirection?: 'asc' | 'desc';
     ...
     */
    static upsert<T extends Model>(this: ModelStatic<T>, data: any, options?: UpsertOptions): Promise<T>;
    /**
     * Find or create.
     */
    static firstOrCreate<T extends Model>(this: ModelStatic<T>, where: WhereCondition, data: any): Promise<T>;
    /**
     * Find or instantiate (without persisting).
     */
    static firstOrNew<T extends Model>(this: ModelStatic<T>, where: WhereCondition, data: any): Promise<T>;
    /**
     * Update or create.
     */
    static updateOrCreate<T extends Model>(this: ModelStatic<T>, where: WhereCondition, data: any): Promise<T>;
    /**
     * Aggregate: sum.
     */
    static sum<T extends Model>(this: ModelStatic<T>, column: string, where?: WhereCondition): Promise<number>;
    /**
     * Aggregate: average.
     */
    static avg<T extends Model>(this: ModelStatic<T>, column: string, where?: WhereCondition): Promise<number>;
    /**
     * Aggregate: minimum.
     */
    static min<T extends Model>(this: ModelStatic<T>, column: string, where?: WhereCondition): Promise<unknown>;
    /**
     * Aggregate: maximum.
     */
    static max<T extends Model>(this: ModelStatic<T>, column: string, where?: WhereCondition): Promise<unknown>;
    /**
     ...
     */
    static castAttribute(key: string, value: unknown, cast: CastType | ((value: unknown) => unknown)): unknown;
    /**
     ...
     */
    static hasMany<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, foreignKey?: string, localKey?: string): void;
    /**
     * Define a belongsTo relation.
     */
    static belongsTo<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, foreignKey?: string, ownerKey?: string): void;
    /**
     * Define a hasOne relation.
     */
    static hasOne<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, foreignKey?: string, localKey?: string): void;
    /**
     * Define a belongsToMany relation (many-to-many).
     */
    static belongsToMany<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, pivotTable: string, foreignKey?: string, relatedKey?: string): void;
    /**
     ...
     */
    static morphTo(this: ModelStatic, relationName?: string, morphType?: string, morphId?: string, morphMap?: Map<string, ModelStatic>): void;
    /**
     ...
     * @param morphId - Polymorphic id column name (default: '{relationName}_id')
     */
    static morphMany<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, relationName: string, morphType?: string, morphId?: string): void;
    /**
     ...
     * @param morphId - Polymorphic id column name (default: '{relationName}_id')
     */
    static morphOne<TRelated extends Model>(this: ModelStatic, related: ModelStatic<TRelated>, relationName: string, morphType?: string, morphId?: string): void;
    /**
