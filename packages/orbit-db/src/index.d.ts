 ...
 */
export default function orbitDB<TSchema extends Record<string, unknown>>(core: PlanetCore, options: OrbitDBOptions<TSchema>): {
    db: any;
};
...
export type { DatabaseType, DeployOptions, DeployResult, HealthCheckResult, MigrateResult, PaginateOptions, PaginateResult, QueryLogInfo, RelationOptions, SeedFunction, SeedResult, } from './types';
