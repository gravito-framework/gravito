 ...
 */
declare class HonoContextWrapper<V extends GravitoVariables = GravitoVariables> implements GravitoContext<V> {
    private honoCtx;
    private _req;
    private _statusCode;
    constructor(honoCtx: Context);
 ...
 */
declare function toHonoMiddleware<V extends GravitoVariables>(middleware: GravitoMiddleware<V>): MiddlewareHandler;
/**
 ...
 * ```
 */
export declare class HonoAdapter<V extends GravitoVariables = GravitoVariables> implements HttpAdapter<V> {
    private config;
    readonly name = "hono";
 ...
 */
export declare function createHonoAdapter<V extends GravitoVariables = GravitoVariables>(config?: AdapterConfig): HonoAdapter<V>;
