...
import { createHonoAdapter } from '../src/adapters/HonoAdapter' // We might need this to mock core? 
...
describe('Router Integration (BunNativeAdapter)', () => {
    ...
    it('should handle resource routes', async () => {
        ...
        class UserController {
            ...
            index(c: any) { return c.text('Index') }
            show(c: any) { return c.text(`Show ${c.req.param('id')}`) }
        }
