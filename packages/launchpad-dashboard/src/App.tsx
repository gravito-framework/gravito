import { Activity, Cpu, Rocket, Terminal } from 'lucide-react'
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">
              GRAVITO <span className="text-sky-400">LAUNCHPAD</span>
            </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {rockets.map((rocketId) => {
          ...
          return (
            <div
              key={rocketId}
              className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-xl hover:border-sky-500/30 transition-all group"
            >
              {/* Card Header */}
              ...
              <div className="grid grid-cols-2 gap-px bg-slate-800">
                ...
                <div className="bg-slate-900 p-4 flex flex-col items-center justify-center gap-1">
                  ...
                  <span className="text-lg font-bold text-white">
                    {rocketStats?.memory.split('/')[0] || '0MB'}
                  </span>
              ...
              <div className="p-4 bg-black font-mono text-[10px] h-48 overflow-hidden relative">
                ...
                <div className="space-y-1">
                  {rocketLogs.length === 0 && (
                    <span className="text-slate-600 italic">Waiting for telemetry...</span>
                  )}
