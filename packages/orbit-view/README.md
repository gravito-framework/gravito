...
```tsx
import { Image, ImageProps } from '@gravito/orbit-view';
```
...
import type { HelperFunction } from '@gravito/orbit-view';
...
OrbitView 會觸發 `view:helpers:register` hook，允許其他模組註冊 helper：
